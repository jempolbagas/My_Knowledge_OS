...
> 
> Supaya kita bisa membandingkan secara adil mana fitur cuaca yang paling dominan memengaruhi AQI, kita wajib melakukan **Z-Score Standardization** terlebih dahulu, persis seperti yang kita bahas di [[../Air Quality Prediction MLR Complete Guide.md|Air Quality Prediction MLR Complete Guide]]. Setelah data disamakan skalanya (mean = 0, std = 1), barulah koefisien $\beta$ yang angkanya paling besar (baik positif maupun negatif) bisa diklaim sebagai fitur yang paling penting bagi model!
