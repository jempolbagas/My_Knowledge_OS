---
title: "Cara Mencari Determinan & Invers Matriks Beserta Contohnya"
source: "https://www.ruangguru.com/blog/cara-mencari-determinan-dan-invers-matriks"
author:
  - "[[Hani Ammariah]]"
published: 2024-02-27
created: 2026-07-28
description: "Artikel ini menjelaskan tentang berbagai macam cara untuk mencari determinan dan invers matriks, lengkap disertai dengan contoh soal dan pembahasannya."
tags:
  - "clippings"
---
## Cara Mencari Determinan & Invers Matriks Beserta Contohnya | Matematika Kelas 11

*![matriks-2](https://cdn-web.ruangguru.com/landing-pages/assets/hs/matriks-2.png)*

> *Dalam artikel **[Matematika kelas 11](https://www.ruangguru.com/blog/tag/matematika-xi)** ini, akan menjelaskan cara mencari determinan dan invers suatu matriks disertai dengan beberapa contoh soal dan pembahasannya.*

*—*

Di artikel sebelumnya, kita *udah* belajar mengenai pengertian serta operasi hitung pada **[matriks](https://www.ruangguru.com/blog/mengenal-matriks-dalam-matematika-pengertian-jenis-dan-transpose)**. *Hayoo*, ada yang masih ingat syarat perkalian dua matriks itu apa? Nah loh! Masa sih *udah* lupa aja. Coba deh baca-baca lagi artikel di **[link ini](https://www.ruangguru.com/blog/matematika-kelas-11-operasi-aljabar-pada-matriks-penjumlahan-pengurangan-dan-perkalian)** kalau kamu lupa.
...
![yes](https://cdn-web.ruangguru.com/landing-pages/assets/hs/ezgif.com-resize.gif)
...
Misalkan,![[determinan1.png|determinan]] adalah matriks berordo 2 x 2. Elemen a dan d terletak pada diagonal utama, sedangkan elemen b dan c terletak pada diagonal kedua. Determinan matriks A dapat diperoleh dengan mengurangkan hasil kali elemen-elemen diagonal utama dengan hasil kali elemen-elemen diagonal kedua.

![[Matematika%20Kelas%2011%20 %20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-10.png|rumus determinan matriks]]
...
![[determinan2.png|determinan]]

**Pembahasan:**

![[Matematika%20Kelas%2011%20%7C%20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-20.png|determinan]]
...
Misalkan,![[determinan4.png|determinan]] adalah matriks berordo 3 x 3. Terdapat dua cara yang bisa dilakukan untuk mencari determinannya, yaitu menggunakan aturan *Sarrus* dan metode minor-kofaktor.

![[Matematika Matriks-03-1.png|Matematika_Matriks-03-1]]
...
**Baca Juga: [Kedudukan Titik dan Garis Lurus pada Lingkaran](https://www.ruangguru.com/blog/kedudukan-titik-dan-garis-lurus-terhadap-lingkaran)**
...
![[Matematika%20Kelas%2011%20%7C%20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-9.png]]
...
![[Matematika%20Kelas%2011%20%7C%20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-12.png]]
...
Berdasarkan rumus minor-kofaktor di atas, determinan matriks A dapat dicari dengan menghitung jumlah seluruh hasil kali antara kofaktor matriks bagian dari matriks A dengan elemen-elemen pada salah satu baris atau kolom matriks A. Jadi, pertama, kita pilih salah satu baris atau kolom matriks A untuk mendapatkan nilai determinannya. Misalnya, kita pilih baris ke-1. Elemen-elemen matriks baris ke-1, yaitu a <sub>11</sub>, a <sub>12</sub>, dan a <sub>13</sub>.

![[Matematika%20Kelas%2011%20%7C%20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-19.png|determinan]]
...
![[Matematika%20Kelas%2011%20%7C%20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-14.png|determinan]]

Langkah kedua, kita cari kofaktor matriks bagian dari matriks A (C <sub>ij</sub>). Cij = (-1) <sup>i+j</sup> M <sub>ij</sub> dan M <sub>ij</sub> = det A <sub>ij</sub> dengan A <sub>ij</sub> merupakan matriks bagian dari matriks A yang diperoleh dengan menghilangkan baris ke-i dan kolom ke-j. Maksudnya bagaimana? Oke, coba kamu perhatikan baik-baik ya.

Sebelumnya, kita telah memilih elemen-elemen pada baris ke-1, yaitu a <sub>11</sub>, a <sub>12</sub>, dan a <sub>13</sub>. Oleh karena itu, matriks bagian dari matriks A nya adalah A <sub>11</sub>, A <sub>12</sub>, dan A <sub>13</sub>.

- A <sub>11</sub> diperoleh dengan menghilangkan elemen-elemen pada baris ke-1 dan kolom ke-1.
![[Matematika%20Kelas%2011%20%7C%20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-8.png|determinan]]
- A <sub>12</sub> diperoleh dengan menghilangkan elemen-elemen pada baris ke-1 dan kolom ke-2.
![[determinan11.png|determinan]]
- A <sub>13</sub> diperoleh dengan menghilangkan elemen-elemen pada baris ke-1 dan kolom ke-3.
![[Matematika%20Kelas%2011%20%7C%20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-3.png|determinan]]

Sehingga,

![[determinan13.png|determinan]]
...
Mau punya banyak latihan soal? Langsung aja cek fitur [Bank Soal](https://link.ruangguru.com/blPk/2c873739) di aplikasi Ruangguru ya.

Oh iya, kamu juga perlu *tau* nih, determinan matriks memiliki beberapa sifat sebagai berikut:

![[Matematika Matriks-07-1.png|sifat determinan matriks]]
...
Pada fungsi invers, kita disuruh mencari kebalikan dari fungsi tersebut. Misalnya *aja*, invers dari f(x) = 2x, maka jawabannya adalah f <sup>-1</sup> (x) = ½ x. Gimana cara mencarinya? Kalau lupa, bisa langsung klik *link* di bawah ini.

**Baca Juga: [Apakah Fungsi Invers itu?](https://www.ruangguru.com/blog/apakah-fungsi-invers-itu)**
...
![[Matematika Matriks-04-1.png|rumus invers matriks]]
...
![[Matematika%20Kelas%2011%20%7C%20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-11.png]]

**Pembahasan:**

![[Matematika%20Kelas%2011%20%7C%20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-7.png]]
...
![[Matematika%20Kelas%2011%20 %20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-16.png|Matematika Kelas 11 _ Cara Mencari Determinan dan Invers Matriks-16]]
...
![[contoh%20invers%20matriks%203x3.png|contoh invers matriks 3x3]]

**Penyelesaian:**

![[Matematika%20Kelas%2011%20%7C%20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-4.png]]
...
![[penyelesaian%20invers%20matriks%203x3.png|penyelesaian invers matriks 3x3]]

Kemudian, kita tentukan adjoin matriks dengan mencari kofaktor matriks A tersebut.

![[penyelesaian%20invers%20matriks%203x3%20(1).png|penyelesaian invers matriks 3x3]]

Oleh karena itu,

![[penyelesaian%20invers%20matriks%203x3%20(2).png|penyelesaian invers matriks 3x3]]

Jadi,

![[penyelesaian%20invers%20matriks%203x3%20(3).png|penyelesaian invers matriks 3x3]]
...
![[Matematika%20Kelas%2011%20 %20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-18.png|rumus invers matriks ordo 3x3]]
...
Pertama-tama, kita bentuk matriks A menjadi matriks (A <sub>3</sub> |I <sub>3</sub>).

![[invers11.png|invers]]

Lalu, kita transformasikan matriks (A <sub>3</sub> |I <sub>3</sub>) ke bentuk (I <sub>3</sub> |A <sub>3</sub>). Kita bisa menggunakan beberapa cara seperti yang dijelaskan poin a-d pada langkah ke-2 rumus di atas.

![[Matematika%20Kelas%2011%20%7C%20Cara%20Mencari%20Determinan%20dan%20Invers%20Matriks-2.png|transformasi baris elementer]]

**Keterangan:**

1) B <sub>2</sub> -2B <sub>1</sub> = elemen-elemen baris ke-2 dikurang 2 kali elemen-elemen baris ke-1.

2) B <sub>3</sub> -2B <sub>1</sub> = elemen-elemen baris ke-3 dikurang 2 kali elemen-elemen baris ke-1.

3) B <sub>3</sub> +B <sub>2</sub> = elemen-elemen baris ke-3 ditambah elemen-elemen baris ke-2.

4) 1/5B <sub>3</sub> = elemen-elemen baris ke-3 dikali degan ⅕.

5) B <sub>2</sub> -2B <sub>3</sub> = elemen-elemen baris ke-2 dikurang 2 kali elemen-elemen baris ke-3.

6) B <sub>1</sub> -B <sub>2</sub> = elemen-elemen baris ke-1 dikurang elemen-elemen baris ke-2.

Sehingga, diperoleh invers matriks A, yaitu:

![[invers13.png|invers]] ![wow](https://cdn-web.ruangguru.com/landing-pages/assets/hs/wow.jpg)
...
Coba deh baca artikel [**7 solusi belajar menghadapi ulangan Matematika**](https://www.ruangguru.com/blog/solusi-belajar-menghadapi-ulangan-matematika) di [**blog Ruangguru**](https://www.ruangguru.com/blog) biar lain kali kamu punya strategi yang tepat agar ulangan kamu nggak remed terus.
...
![[Matematika Matriks-08-1.png|sifat-sifat invers matriks]]
