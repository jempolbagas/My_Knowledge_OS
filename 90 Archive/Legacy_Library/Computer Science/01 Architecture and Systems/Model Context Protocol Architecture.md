...
- [[Model Context Protocol]]: Atomic concept definition for the universal context protocol.
- [[JSON RPC 2 0]]: Transport-agnostic messaging format used across MCP data layers.
