...
> 1. 📄 **[[01_Konsep_Sinyal_dan_Frekuensi]]**: Definisi sinyal, klasifikasi (CT vs DT, Analog vs Digital, Deterministik vs Acak), dan hubungan frekuensi analog vs digital.
> 2. 📄 **[[02_Elemen_Dasar_Sistem_DSP]]**: Rantai blok arsitektur DSP, prinsip kerja Anti-Aliasing Filter, mekanisme ADC (Sampling, Kuantisasi, Encoding), DSP Core, DAC, dan Reconstruction Filter.
> 3. 📄 **[[03_Bidang_Aplikasi_DSP]]**: Studi kasus penerapan DSP dalam pengolahan audio, pengolahan citra digital, telekomunikasi nirkabel, biomedis (ECG/EEG), dan radar.
...
- 📄 **[[Week_01_Introduction_to_DSP_Drills]]**

Untuk kartu referensi cepat dan formula kunci:
- 📄 **[[Week_01_Introduction_to_DSP_Cheatsheet]]**
...
> - `[[Sinyal_Waktu_Diskrit]]`: Representasi matematika dan notasi deret $x[n]$.
> - `[[Konversi_Analog_ke_Digital_ADC]]`: Mekanisme sampling, kuantisasi $B$-bit, dan frekuensi Nyquist.
> - `[[Aliasing_Sinyal]]`: Fenomena lipatan frekuensi akibat pelanggaran kriteria Nyquist.
