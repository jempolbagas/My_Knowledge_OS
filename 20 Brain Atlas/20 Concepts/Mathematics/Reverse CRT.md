...
source: "[[Chinese Remainder Theorem and Reverse CRT Guide]]"
created: 2026-08-06
---
...
- **[[Chinese Remainder Theorem]] (Reconstruction):** Menggabungkan kembali pecahan $(r_1, r_2, \dots, r_n)$ menjadi nilai asli $I \pmod M$ dengan formula:
  $$I = \left( \sum_{i=1}^{n} r_i \cdot m_i \cdot m_i^{-1} \right) \bmod M$$
  dengan $m_i = \frac{M}{P_i}$ dan $m_i^{-1}$ sebagai [[Invers Modular]] dari $m_i \pmod{P_i}$.
