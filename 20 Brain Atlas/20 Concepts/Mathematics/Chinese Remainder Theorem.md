...
- $m_i^{-1}$ adalah [[Invers Modular]] dari $m_i \pmod{P_i}$

## Aplikasi Kriptografi
- **[[Reverse CRT]]:** Digunakan untuk memecah data acak/piksel rahasia menjadi komponen sisa bagi (*shares*).
