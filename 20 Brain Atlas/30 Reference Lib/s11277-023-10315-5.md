---
type: reference
title: "Single Secret Sharing Scheme Using Chinese Remainder Theorem, Modified Shamir’s Scheme and XOR Operation"
subject: "Cybersecurity"
doi: "10.1007/s11277-023-10315-5"
created: 2026-09-03
tags: [reference, paper, cryptography, secret-sharing]
---
...
![[illustration cybersecurity secret sharing scheme flow.webp]]
...
![[infographic cybersecurity secret sharing comparison table.webp]]
...
![[illustration cybersecurity secret sharing share reconstruction.webp]]
...
![[infographic cybersecurity secret sharing performance metrics.webp]]
...
![[chart cybersecurity secret sharing npcr uaci analysis.webp]]
...
![[chart cybersecurity secret sharing noise robustness curve.webp]]
...
6. **Sharing Capacity** The number of secrets divided by the number of shares represents the sharing capacity. The proposed scheme has a $\frac{1}{n}$ shareable capacity. The current schemes [14, 25, 32, 33, 42, 43, 52] compatible with $\frac{1}{n}$ sharing capacity, [15] compatible with $\frac{1}{2^h}$ sharing capacity.

7. **Multi-threshold** The proposed solution does not support multiple threshold values and requires the $n$ shares in order to reconstruct the secret. The current schemes [25, 32, 33, 42, 52] compatible with the multi threshold secret sharing scheme, [14, 15, 43] is not compatible with multiple threshold values.

8. **Meaningful Shares** The proposed strategy does not utilize meaningful shares; nevertheless, [15, 25, 52] recommends the use of meaningful shares.
