---
title: "3 Cara Mudah Menyelesaikan Persamaan Kuadrat"
source: "https://www.ruangguru.com/blog/menyelesaikan-persamaan-kuadrat"
author:
  - "[[Kenya Swawikanti]]"
published: 2025-02-04
created: 2026-07-28
description: "Gimana sih cara menyelesaikan persamaan kuadrat dalam matematika? Yuk, simak tiga cara mudah menyelesaikan persamaan kuadrat serta contohnya berikut ini!"
tags:
  - "clippings"
promoted_to: "[[Persamaan_Kuadrat]]"
---
## 3 Cara Mudah Menyelesaikan Persamaan Kuadrat | Matematika Kelas 9

![Cara Menyelesaikan Persamaan Kuadrat](https://cdn-web.ruangguru.com/landing-pages/assets/hs/Cara%20Menyelesaikan%20Persamaan%20Kuadrat.png)
...
Jenis-jenis persamaan dalam matematika pun ada banyak, lho! Ada persamaan linier, persamaan kuadrat, persamaan **[eksponen](https://www.ruangguru.com/blog/bilangan-berpangkat-pengertian-dan-sifatnya)**, persamaan logaritma, persamaan trigonometri, dan lain sebagainya. Duh, denger namanya aja, udah bikin pusing duluan, ya?
...
Persamaan kuadrat adalah **persamaan [polinomial](https://www.ruangguru.com/blog/konsep-dan-nilai-suku-banyak) (suku banyak) variabel 1 yang memiliki pangkat tertinggi dua**. Ingat, ya, pangkat tertingginya dua! Jadi, kalau kamu nyariin pangkat tiga di persamaan kuadrat, ya kagak bakalan ketemu, yak.
...
**Baca Juga: [Cara Menyusun Persamaan Kuadrat dan Contohnya](https://www.ruangguru.com/blog/menyusun-persamaan-kuadrat)**
...
| --- | --- | --- |
| 1. | x <sup>2</sup> + 2xy + y <sup>2</sup> = 0 | (x + y) <sup>2</sup> = 0 |
| 2. | x <sup>2</sup> − 2xy + y <sup>2</sup> = 0 | (x − y) <sup>2</sup> = 0 |
| 3. | x <sup>2</sup> − y <sup>2</sup> = 0 | (x + y)(x − y) = 0 |
...
Selesaikan persamaan kuadrat berikut dengan cara faktorisasi 5x <sup>2</sup> + 13x + 6 = 0!

**Jawab:**

5x <sup>2</sup> + 13x + 6 = 0

5x <sup>2</sup> + 10x + 3x + 6 = 0
...
x = ![35-Aug-12-2022-02-15-37-16-AM](https://cdn-web.ruangguru.com/landing-pages/assets/hs/35-Aug-12-2022-02-15-37-16-AM.png) atau x = −2

Jadi, penyelesaiannya adalah x = ![35-Aug-12-2022-02-15-37-16-AM](https://cdn-web.ruangguru.com/landing-pages/assets/hs/35-Aug-12-2022-02-15-37-16-AM.png) atau x = −2.
...
> **(x + p) <sup>2</sup> = x <sup>2</sup> + 2px + p <sup>2</sup>**

Dari bentuk tersebut, kamu bisa ubah menjadi bentuk persamaan dalam (x + p) <sup>2</sup> = q
...
Lengkapi bentuk kuadrat sempurna berikut ini x <sup>2</sup> + 6x + 5 = 0!

**Jawab:**

x <sup>2</sup> + 6x + 5 = 0

Ubah menjadi x <sup>2</sup> + 6x = −5

Tambahkan satu angka di ruas kiri dan kanan agar menjadi kuadrat sempurna. Penambahan angka ini diambil dari separuh angka koefisien dari x atau separuhnya 6 yang dikuadratkan, yakni 3 <sup>2</sup> = 9. Tambahkan angka 9 di ruas kiri dan kanan, sehingga persamaannya menjadi:
...
**Baca Juga: [Ketahui Sifat-Sifat Bentuk Akar & Cara Merasionalkannya](https://www.ruangguru.com/blog/bilangan-bentuk-akar-sifat-sifat-dan-cara-merasionalkannya)**
...
![Rumus ABC Rumus Kuadratik](https://cdn-web.ruangguru.com/landing-pages/assets/hs/Rumus%20ABC%20Rumus%20Kuadratik.png)

Next, coba kamu kerjakan contoh soal berikut!

#### Contoh Soal Rumus Kuadratik

Selesaikan persamaan kuadrat x <sup>2</sup> + 4x − 12 = 0 menggunakan rumus kuadratik (rumus ABC)!
...
![rumus abc](https://cdn-web.ruangguru.com/landing-pages/assets/hs/rumus%20abc.png)

Jadi, penyelesaiannya adalah x = 2 atau x = −6.

—

Nah, itu dia pembahasan tentang cara menyelesaikan persamaan kuadrat. Sudah paham, kan? Kalau kamu masih bingung dan masih ada pertanyaan terkait materi ini, langsung saja tanyakan melalui **[Roboguru](https://roboguru.ruangguru.com/)**!

[![IDN CTA Blog roboguru plus Ruangguru](https://cdn-web.ruangguru.com/landing-pages/assets/cta/a0a38c01-0a03-4469-8a8f-60dc108e3138.png)](https://www.ruangguru.com/roboguruplus)
