---
title: "Trigonometri SMA — Master Dashboard & Peta Belajar"
...
sources:
  ...
  - "[[Soal_Trigonometri_SMA_Level_1_Fondasi]]"
  - "[[Soal_Trigonometri_SMA_Level_2_Standar_HOTS]]"
tags:
...
```mermaid
flowchart TD
    subgraph FaseE ["Fase E (Kelas 10) — Geometri & Rasio Segitiga"]
        M1["[[Perbandingan_Trigonometri_dan_Sudut_Istimewa_SMA|Modul 1: Rasio Dasar & Sudut Istimewa]]<br>• Definisi De-Sa-Mi<br>• Rasio Kebalikan (csc, sec, cot)<br>• Deduksi Geometris 30°, 45°, 60°<br>• Klinometer & Sudut Elevasi"]
        M2["[[Sudut_Berelasi_dan_Lingkaran_Satuan_SMA|Modul 2: Lingkaran Satuan & Sudut Berelasi]]<br>• Unit Circle r = 1<br>• Kuadran I-IV (ASTC Rules)<br>• Sudut Relasi (90°, 180°, 270°, 360°)<br>• Sudut Negatif & Periodisitas"]
    end

    subgraph FaseF ["Fase F (Kelas 11) — Analitik, Aljabar & Fungsi"]
        M3["[[Identitas_dan_Rumus_Jumlah_Selisih_Sudut_SMA|Modul 3: Identitas & Rumus Analitik]]<br>• Identitas Pythagoras<br>• Rumus sin(a±b), cos(a±b), tan(a±b)<br>• Sudut Ganda & Sudut Paruh<br>• Konversi Perkalian & Penjumlahan"]
        M4["[[Aturan_Sinus_Cosinus_dan_Luas_Segitiga_SMA|Modul 4: Segitiga Sebarang & Luas]]<br>• Aturan Sinus & Kasus Ambigu (SSA)<br>• Aturan Cosinus (SAS & SSS)<br>• Luas Segitiga via Sinus & Heron<br>• Aplikasi Navigasi & Jarak"]
        M5["[[Grafik_Fungsi_dan_Persamaan_Trigonometri_SMA|Modul 5: Grafik Gelombang & Persamaan]]<br>• Karakteristik Gelombang Sin, Cos, Tan<br>• Amplitudo, Periode & Pergeseran Fasa<br>• Solusi Persamaan Dasar dlm Derajat/Radian<br>• Persamaan Kuadrat Bentuk Trigonometri"]
    end

    subgraph PracticeHub ["Evaluasi & Praktik Bertingkat"]
        P1["[[LKPD_Trigonometri_SMA|📝 LKPD Eksplorasi Terpadu]]<br>Aktivitas Kelompok, Guided Discovery & Lab Mini"]
        P2["[[Soal_Trigonometri_SMA_Level_1_Fondasi|🎯 Soal Level 1: Fondasi]]<br>Drill Operasi, Konversi & Perhitungan Dasar"]
        P3["[[Soal_Trigonometri_SMA_Level_2_Standar_HOTS|🚀 Soal Level 2: Standar UTBK & HOTS]]<br>Penalaran Aljabar, Analisis Grafik & Studi Kasus"]
    end
