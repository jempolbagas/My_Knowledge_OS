...
```mermaid
graph TD
    IlmuEko["Taksonomi Ilmu Ekonomi"]
    
    Deskriptif["1. Ekonomi Deskriptif<br/>(Descriptive Economics)"]
    Teori["2. Teori Ekonomi<br/>(Economic Theory)"]
    Terapan["3. Ekonomi Terapan<br/>(Applied Economics)"]

    IlmuEko --> Deskriptif
    IlmuEko --> Teori
    IlmuEko --> Terapan

    Teori --> Mikro["Ekonomi Mikro<br/>(Perilaku Individu & Pasar Komoditas)"]
    Teori --> Makro["Ekonomi Makro<br/>(Variabel Agregat & Perekonomian Nasional)"]

    Terapan --> E1["Ekonomi Moneter & Perbankan"]
    Terapan --> E2["Ekonomi Publik & Fiskal"]
    Terapan --> E3["Ekonomi Syariah"]
    Terapan --> E4["Ekonomi Pembangunan & Lingkungan"]
```
...
```mermaid
graph LR
    Analisis["Pernyataan Ekonomi"]
    
    Positif["Pernyataan POSITIF<br/>(What is / Facts)<br/>Objektif, Hubungan Sebab-Akibat, Dapat Diuji Empiris"]
    Normatif["Pernyataan NORMATIF<br/>(What ought to be / Values)<br/>Subjektif, Penilaian Moral/Etika, Rekomendasi Kebijakan"]
