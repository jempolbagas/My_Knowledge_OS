...
```mermaid
graph TD
    TigaMasalah["3 Masalah Pokok Ekonomi Modern"]
    
    What["1. WHAT to produce?<br/>(Barang apa & Berapa banyak)"]
    How["2. HOW to produce?<br/>(Teknik & Kombinasi Faktor Produksi)"]
    ForWhom["3. FOR WHOM to produce?<br/>(Distribusi & Target Konsumen)"]

    TigaMasalah --> What
    TigaMasalah --> How
    TigaMasalah --> ForWhom

    What --> W1["Alokasi Komoditas: Pangan vs Senjata / Konsumsi vs Modal"]
    How --> H1["Teknologi: Padat Karya (Labor) vs Padat Modal (Capital)"]
    ForWhom --> F1["Distribusi Keadilan: Daya Beli & Segmentasi Pendapatan"]
```
...
```mermaid
graph TD
    DemokrasiEko["Sistem Demokrasi Ekonomi Indonesia (Pasal 33 UUD 1945)"]
    
    Pilar["Tiga Pilar Pelaku Ekonomi"]
    Prinsip["Prinsip Penyelenggaraan"]
    Tabu["Ciri Negatif yang Dilarang"]

    DemokrasiEko --> Pilar
    DemokrasiEko --> Prinsip
    DemokrasiEko --> Tabu

    Pilar --> BUMN["1. BUMN / BUMD (Penguasa Cabang Vital)"]
    Pilar --> BUMS["2. BUMS (Penggerak Dinamika Pasar)"]
    Pilar --> Koperasi["3. KOPERASI (Soko Guru Asas Kekeluargaan)"]

    Prinsip --> P1["Asas Kekeluargaan & Kebersamaan"]
    Prinsip --> P2["Efisiensi Berkeadilan & Kemandirian"]
    Prinsip --> P3["Kekayaan Alam untuk Kemakmuran Rakyat"]

    Tabu --> T1["Free Fight Liberalism (Eksploitasi Modal)"]
    Tabu --> T2["Etatisme (Monopoli Mutlak Negara)"]
    Tabu --> T3["Monopoli & Oligopoli Merugikan (Rente)"]
```
