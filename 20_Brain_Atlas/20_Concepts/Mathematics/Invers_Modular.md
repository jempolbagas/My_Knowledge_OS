...
1. **Invers (Kebalikan):** Pada aritmatika biasa, invers perkalian dari $A$ adalah $\frac{1}{A}$ karena $A \cdot \frac{1}{A} = 1$. Dalam [[Kongruensi_Modular]], pecahan tidak diizinkan, sehingga posisi $\frac{1}{A}$ digantikan oleh bilangan bulat $y$.
...
## Kegunaan
- Digunakan dalam [[Chinese_Remainder_Theorem]] untuk menghitung komponen bobot rekonstruksi.
