...
3. **Polynomial Interpolation:** Fits a single polynomial of degree $\le n$ through all points (e.g., [[Lagrange_Interpolation]]).
4. **Spline Interpolation:** Fits piecewise low-degree polynomials (e.g., Cubic Splines) between neighboring pairs, preserving continuous derivatives and avoiding [[Runges_Phenomenon|Runge's phenomenon]].
...
- **Cryptography:** Polynomial secret reconstruction in [[Shamir_Secret_Sharing]].
