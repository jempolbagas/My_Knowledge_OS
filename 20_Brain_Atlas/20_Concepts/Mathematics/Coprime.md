...
- **[[Chinese_Remainder_Theorem]]:** CRT mewajibkan himpunan modulo $\{p_1, p_2, \dots, p_n\}$ bersifat *pairwise coprime* ($\gcd(p_i, p_j) = 1$ untuk $i \neq j$) agar keunikan solusi $x \pmod M$ terjamin.
- **[[Kongruensi_Modular]] & Invers Modular:** Invers multiplikatif $a^{-1} \pmod m$ hanya ada jika dan hanya jika $\gcd(a, m) = 1$.
