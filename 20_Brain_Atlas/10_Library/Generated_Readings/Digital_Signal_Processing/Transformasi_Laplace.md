...
promoted_to: 
  - "[[Bidang_S_Complex_Plane]]"
  - "[[Region_of_Convergence_ROC]]"
---
...
Tidak semua sinyal bisa diintegralkan sampai tak hingga (nilainya bisa "meledak" dan tidak terdefinisi). Kumpulan nilai $s$ di mana integral tersebut memberikan hasil yang terbatas (konvergen) disebut dengan **[[Region_of_Convergence_ROC|Region of Convergence (ROC)]]**.
